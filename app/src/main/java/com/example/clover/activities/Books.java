...
public class Books extends AppCompatActivity implements BookAdapter.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //read pitch and speed from firebase
        readData();

        //set up toolbar, search view, and recycler view
    ...
    public void setUpBookList(){
        ...
        bookList.add(9, new PersonalInfoItem("Six Days at Camp with Jack and Max", "Jack Mills and Max Finn are excited to spend six days at camp. Except, they cannot stand each other. And this could turn out to be a disaster. When things get out of control, Jack and Max are forced to work things out on their own. Can these boys be able to overcome the past and become friends? Simple Words Books help struggling readers to become better readers, without tears. Our decodable books support improving their reading fluency, comprehension and confidence.", R.drawable.camp));
        bookList.add(10, new PersonalInfoItem("Six Days at Camp with Lin and Jill", "Lin Mills and Jill Finn are excited to spend six days at camp. Except, they cannot stand each other. And this could turn out to be a disaster. When things get out of control, Jill and Lin are forced to work things out on their own. Can these girls be able to overcome the past and become friends? Simple Words Books help struggling readers to become better readers, without tears. Our decodable books support improving their reading fluency, comprehension and confidence.", R.drawable.girlcamp));
    ...
    //get speed and pitch from firebase
